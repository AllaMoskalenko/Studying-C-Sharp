...
3. предусмотреть кнопку для перемещения выбраного круга (
имею в виду, что из перечня(ComboBox) можно выбрать круг, 
а потом по нажатию кнопки переместить его на dx вправо и на dy вниз)
    */
{
